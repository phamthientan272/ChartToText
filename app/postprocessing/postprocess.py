...
def replaceTrends(reverse, sentenceTemplates: dict):
...
def post_processing(captions, data_inputs, titles):
    count = 0
    outputs = []
    for generated, data, title in zip(captions, data_inputs, titles):
        templateList = []
        count += 1
        datum = data.split()
